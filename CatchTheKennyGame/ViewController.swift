...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let storedHighScore = UserDefaults.standard.object(forKey: "high score")
        ...
        kennyArray = [kenny1, kenny2, kenny3, kenny4, kenny5, kenny6, kenny7, kenny8, kenny8, kenny9]
    ...
    @objc func timerFunction() {
        ...
        if counter == 0 {
            ...
            if self.score > self.highScore{
                ...
                highScoreText.text = "High score: \(self.highScore) "
                UserDefaults.standard.setValue(self.highScore, forKey: "high score")
            ...
            let replayButton = UIAlertAction(title: "Replay", style: UIAlertAction.Style.default) {
                ...
                self.counter = 10
                self.timeText.text = "Time : \(self.counter)"
